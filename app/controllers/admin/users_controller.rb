class Admin::UsersController < ApplicationController
  ...
  def create
    ...
    if params[:typeid] == "1"
     @member_obj = Loginmember.new(params[:user])
     @member_obj.save
    elsif params[:typeid] == "2"
     @member_obj = Operator.new(params[:user])
     @member_obj.save
    elsif params[:typeid] == "3"
     @member_obj = Secretory.new(params[:user])
     @member_obj.save
    end
