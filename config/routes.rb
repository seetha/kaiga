...
ActionController::Routing::Routes.draw do |map|
  map.resources :subscription_settings
  ...
  map.resources :subscription_details

  map.resources :fixed_deposits

  map.resources :fdforms

  map.resources :loans

  map.resources :members, :collection=>{:upload=>:get,:uploadimage=>:post}
